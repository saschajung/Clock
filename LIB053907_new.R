...
write.table(coeff,file = "./LIB053907_Coefficients_final.txt", sep = "\t", quote = F, row.names = F, col.names = T)
write.table(preds_total,file = "./LIB053907_Preds_final.txt", sep = "\t", quote = F, row.names = F, col.names = T)
