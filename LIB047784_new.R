...
write.table(coeff,file = "./LIB047784_Coefficients_final.txt", sep = "\t", quote = F, row.names = F, col.names = T)
write.table(preds_total,file = "./LIB047784_Preds_final.txt", sep = "\t", quote = F, row.names = F, col.names = T)
