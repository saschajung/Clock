...
write.table(coeff,file = "./LIBERR260891_Coefficients_final.txt", sep = "\t", quote = F, row.names = F, col.names = T)
write.table(preds_total,file = "./LIBERR260891_Preds_final.txt", sep = "\t", quote = F, row.names = F, col.names = T)
