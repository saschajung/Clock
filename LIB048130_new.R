...
write.table(coeff,file = "./LIB048130_Coefficients_final.txt", sep = "\t", quote = F, row.names = F, col.names = T)
write.table(preds_total,file = "./LIB048130_Preds_final.txt", sep = "\t", quote = F, row.names = F, col.names = T)
