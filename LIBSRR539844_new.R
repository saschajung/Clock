...
write.table(coeff,file = "./LIBSRR539844_Coefficients_final.txt", sep = "\t", quote = F, row.names = F, col.names = T)
write.table(preds_total,file = "./LIBSRR539844_Preds_final.txt", sep = "\t", quote = F, row.names = F, col.names = T)
