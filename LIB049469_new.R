...
write.table(coeff,file = "./LIB049469_Coefficients_final.txt", sep = "\t", quote = F, row.names = F, col.names = T)
write.table(preds_total,file = "./LIB049469_Preds_final.txt", sep = "\t", quote = F, row.names = F, col.names = T)
