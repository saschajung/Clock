...
write.table(coeff,file = "./LIB050518_Coefficients_final.txt", sep = "\t", quote = F, row.names = F, col.names = T)
write.table(preds_total,file = "./LIB050518_Preds_final.txt", sep = "\t", quote = F, row.names = F, col.names = T)
